    ...
    return (
        <>  
            <Wrapper justifyContent="start">
                <Flex justifyContent="end" alignItems="end" width="100vw" backgroundImage="url(/banner/luanoliveira.jpg)" backgroundPosition="center top" backgroundRepeat="no-repeat" backgroundAttachment="fixed" backgroundSize="cover" minHeight={500} padding={8}>
